...
SWIFT_MODULE_NAMESPACE_PUSH("RxBluetoothKit")

@interface CBCentralManager (SWIFT_EXTENSION(RxBluetoothKit))
...
@interface CBDescriptor (SWIFT_EXTENSION(RxBluetoothKit))
@property (nonatomic, readonly, copy) NSString * _Nonnull logDescription;
@end
...
@interface CBService (SWIFT_EXTENSION(RxBluetoothKit))
@property (nonatomic, readonly, copy) NSString * _Nonnull logDescription;
@end
